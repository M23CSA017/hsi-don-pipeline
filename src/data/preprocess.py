...
# # def sensor_drift_check(df: pd.DataFrame) -> None:
# #     """
# #     Placeholder for sensor drift checks (optional advanced step).

# #     :param df: Raw DataFrame with reflectance columns.
# #     """
# #     logger.info("Sensor drift check placeholder: Implement time/batch-based checks if available.")
...
# # Define plot save directory using relative path
# BASE_DIR = os.path.dirname(os.path.abspath(__file__))  # Get current script's directory
# PLOT_DIR = os.path.join(BASE_DIR, "outputs", "plots", "eda")
# os.makedirs(PLOT_DIR, exist_ok=True)
...
#     plt.ylabel("Reflectance")
#     plt.legend()
#     plt.savefig(os.path.join(PLOT_DIR, "average_reflectance.png"), bbox_inches="tight")
#     plt.show()
...
#     plt.xlabel("DON (ppb)")
#     plt.ylabel("Frequency")
#     plt.savefig(os.path.join(PLOT_DIR, "don_distribution.png"), bbox_inches="tight")
#     plt.show()
...
#         plt.xlabel("Reflectance")
#         plt.ylabel("Frequency")
#         plt.savefig(os.path.join(PLOT_DIR, f"hist_band_{float(band):.1f}.png"), bbox_inches="tight")
#         plt.show()
...
#     plt.ylabel("Reflectance")
#     plt.xticks(rotation=45)
#     plt.savefig(os.path.join(PLOT_DIR, "boxplot_selected_bands.png"), bbox_inches="tight")
#     plt.show()
...
#     plt.xlabel("Wavelength (nm)")
#     plt.ylabel("Variance")
#     plt.savefig(os.path.join(PLOT_DIR, "variance_plot.png"), bbox_inches="tight")
#     plt.show()
...
#     plt.ylabel("Smoothed Reflectance")
#     plt.legend()
#     plt.savefig(os.path.join(PLOT_DIR, "smoothed_signatures.png"), bbox_inches="tight")
#     plt.show()
...
#     plt.xlabel("Sample Index")
#     plt.ylabel("Wavelength (nm)")
#     plt.savefig(os.path.join(PLOT_DIR, "spectral_heatmap.png"), bbox_inches="tight")
#     plt.show()
...
#     sns.pairplot(pairplot_data)
#     plt.suptitle("Pairplot of Selected Bands", y=1.02)
#     plt.savefig(os.path.join(PLOT_DIR, "pairplot_selected_bands.png"), bbox_inches="tight")
#     plt.show()
...
#     plt.legend()
#     plt.grid(True)
#     plt.savefig(os.path.join(PLOT_DIR, "pca_explained_variance.png"), bbox_inches="tight")
#     plt.show()
